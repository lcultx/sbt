...
import {ComplieToolsFactory} from './ComplieToolsFactory';
...
export class ComplieTools extends BaseTools {
   ...
   private _factory: ComplieToolsFactory;
   ...
   public init(moduleName: string,
      ...
      this._factory = new ComplieToolsFactory();
